		...
		getSizePic: function(){
			...
			while(i<orderNum){
               ...
               var oProductModel =  new sap.ui.model.xml.XMLModel();
				...
				var productPicUri = uripre + "/ws410/rest/catalogs/apparelProductCatalog/catalogversions/Online/products/" + productCode + "?product_attributes=name,picture" ;
